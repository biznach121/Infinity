  ...
  return (
    <section className="spabox-page">
      <div className="spabox-shell max-w-[760px] text-center">
        ...
        {error.digest && (
          <p className="mt-6 text-xs font-mono text-[#661e38]/60">
            Reference: <code className="text-[#59022b]">{error.digest}</code>
          </p>
        )}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex min-h-14 items-center justify-center border border-[#59022b]/18 px-7 text-sm font-semibold text-[#59022b] transition-colors hover:bg-[#f3caaf]"
          >
            Back home
          </Link>
        </div>
