...
export const brand: Brand = {
  name: "Infinity Spa",
  shortName: "Infinity",
  microTag: "MELT AWAY STRESS, FIND BLISS",
  description:
    "Infinity Spa is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0548312182",
    phoneTel: "+233548312182",
    textPhone: "0548312182",
    textPhoneTel: "+233548312182",
    email: "hello@infinity.test",
    privacyEmail: "privacy@infinity.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@infi_nityspa", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "Infinity Spa exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "Infinity Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Infinity Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Infinity Spa beauty ritual",
    ...
    items: [
      {
        ...
        imageAlt: "Infinity Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Infinity Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Infinity Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Infinity Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@infi_nityspa",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783491710/stage4/spa_infinityspa/tiktok_0.mp4",
        alt: "Infinity Spa treatment video",
        position: "center",
      },
      {
  ...
  about: {
    eyebrow: "About Infinity Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Infinity Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0548312182 and text 0548312182 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0548312182, text 0548312182, or message @infi_nityspa on Instagram." },
          ...
          { q: "Where are you located?", a: "Infinity Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@infinity.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Infinity Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@infinity.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Infinity Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@infinity.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Infinity Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0548312182", href: "tel:+233548312182" },
      { label: "Text", value: "0548312182", href: "sms:+233548312182" },
      { label: "Instagram", value: "@infi_nityspa", href: "https://www.tiktok.com/@infi_nityspa" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783491701/stage4/spa_infinityspa/avatar.jpg",
    blurb:
      "Infinity Spa in Accra — melt away stress, find bliss.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@infi_nityspa" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0548312182", href: "tel:+233548312182" },
          { label: "Text 0548312182", href: "sms:+233548312182" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Infinity Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
