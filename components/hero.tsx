...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#8e000a] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#a00019]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(95, 0, 4,0.58),rgba(129, 0, 10,0.22)_43%,rgba(96, 0, 9,0.34)),linear-gradient(0deg,rgba(50, 2, 6,0.18),rgba(50, 2, 6,0.08))]" />
