...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783491700/stage4/spa_infinityspa/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Infinity Spa - Melt away stress, find bliss">
        <Image
          src={src}
          alt="Infinity Spa - Melt away stress, find bliss"
          fill
